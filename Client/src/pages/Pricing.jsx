...
function Pricing() {
  ...
  const plans = [
    {
        ...
        price: '$7',
        credits: 150,
        description: 'Perfect for individuals exploring creative tools for the first time.',
        features: [
    ...
    },
    {
        ...
        price: '$25',
        credits: 600,
        description: 'Designed for growing creators who need more flexibility and power.',
        features: [
    ...
    },
    {
        ...
        price: '$79',
        credits: 1600,
        description: 'Built for teams and businesses requiring maximum output and reliability.',
        features: [
  ...
  return (
    <>
      <div className="w-ful max-w-%xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
