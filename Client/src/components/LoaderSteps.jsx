...
const steps = [
    ...
    {icon: SquareLineIcon, label: "Generating layot structure..."},
...
function LoaderSteps() {
  ...
  return (
    <div className="w-full h-full flex felx-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
        <div className="absolute inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 to-fuchisia-500/10 blur-3xl animate-pulse">
        </div>
        ...
        {/* Step laber - fade using transition only (no invisible start)  */}
        <p key ={current}
